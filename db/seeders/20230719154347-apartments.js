    ...
    await queryInterface.bulkInsert("Apartments", [
      {
        ...
        mainPhoto:
          "https://avatars.dzeninfra.ru/get-zen_doc/4864152/pub_6391f3c97831e117643876f9_639215f821a7532cbe2583a4/scale_1200",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        mainPhoto:
          "https://www.vsem-kvartira.ru/wp-content/uploads/2021/10/kvartira-sssr-1024x512.jpeg",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        mainPhoto:
          "https://www.vgrealty.ru/images/articles/165/thumbs/0c008b102.jpg",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ]);
